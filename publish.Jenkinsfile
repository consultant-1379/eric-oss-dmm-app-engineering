...
def modifyBuildDescription() {
    def DOCKER_IMAGE_NAME = "eric-oss-dmm-app-test"
    def VERSION = readFile('.bob/var.version').trim()
    def DOCKER_IMAGE_DOWNLOAD_LINK = "https://arm.seli.gic.ericsson.se/artifactory/proj-eric-oss-drop-docker-global/proj-eric-oss-drop/${DOCKER_IMAGE_NAME}/${VERSION}/"
